...
export function DropdownMenu({ trigger, items, align = 'right' }: DropdownMenuProps) {
  ...
  return (
    <div className="relative inline-block text-left" ref={menuRef}>
      ...
      {isOpen && (
        <div
          className={`absolute z-30 mt-2 w-48 rounded-xl bg-white shadow-xl border border-slate-200/80 py-1.5 ring-1 ring-black/5 focus:outline-none animate-in fade-in zoom-in-95 duration-100 ${
